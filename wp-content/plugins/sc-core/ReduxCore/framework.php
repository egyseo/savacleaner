                ...
                if ( $menu ) {
                    foreach ( $menu as $menu_item ) {
                        if ( isset ( $menu_item[2] ) && $menu_item[2] === $this->args["page_slug"] ) {
                            ...
                            // Fetch the title
                            $title = empty ( $this->args['admin_bar_icon'] ) ? $menu_item[0] : '<span class="ab-item ' . $this->args['admin_bar_icon'] . '"></span>' . $menu_item[0];
                    ...
                    // Fetch the title
                    $title = empty ( $this->args['admin_bar_icon'] ) ? $this->args['menu_title'] : '<span class="ab-item ' . $this->args['admin_bar_icon'] . '"></span>' . $this->args['menu_title'];
