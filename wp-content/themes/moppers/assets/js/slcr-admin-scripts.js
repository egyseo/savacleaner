...
jQuery(document).ready(function ($) {
    ...
    function ACF_metabox_tabs() {
        ...
        $(".acf-postbox").each(function () { 
            ...
            var tab_name = $(this).find('.hndle span').text();
            var tab_id = this.id;
        ...
        $(".tabbed-metaboxes .tabs li").live('click', function () {  
            setTimeout(
                function () {
        ...
        $(".tabbed-metaboxes").prepend('<h2 class="mvl_hndle hndle ui-sortable-handle"><span>Advance page and post options</span></h2> <a href="https://slashcreative.co/docs/moppers" target="_blank" class="custom-docs-link"><i class="dashicons dashicons-testimonial"></i>Need Support?</a>');
        if(any_metaboxes==0){
    ...
    $("body").delegate(".post-format", "click", function () {
        var id = this.id;
        list_refresh(id);
    }); 
    // for gutenburg update
    $("body").delegate(".editor-post-format__content .components-select-control__input", "change", function () {
        var id = this.value;
        list_refresh(id);
    }); 

    $("body").delegate("#page_template", "change", function () {
    ...
    // for gutenburg update
    $("body").delegate(".editor-page-attributes__template .components-base-control__field .components-select-control__input", "change", function () {
        if ($(this).val() == 'portfolio.php') {
            $(".slcr_acf_tabs_8904593490").prepend('<li class="slcr-acf-group-list active" id="li-slcr-acf-group_acf_portfolio-settings" rel="slcr-acf-group_acf_portfolio-settings"><i class="icons-grid"></i>Portfolio Settings</li>');
            setTimeout(
                function () {
    ...
    $("body").delegate(".type-select-image", "click", function () {
    ...
    if ($('.vc_ui-flex-row[data-tab="default_templates"]')) {
        ...
        $("#all_slcr_vc_templates").on("click", function () {
            $(".vc_templates-template-type-default_templates").show();
        });
        $("#slcr__temp_filter_section li").on("click", function () {
        ...
        $("#slcr__temp_filter_page li").on("click", function () {
            if ($(this).hasClass('active')) {} else {
                $(".vc_templates-template-type-default_templates").hide();
                var cat = $(this).attr("class");
                $(".vc_templates-template-type-default_templates").each(function () {
        ...
        $('.slcr__temp_filter li').on('click', function () {
    ...
    $(".vc_ui-list-bar-item .img-wrap").on("click", function () {
    ...
    if ($('.documentation_slcr')[0]) {
        $('.documentation_slcr').find('a').attr("href", "https://slashcreative.co/docs/moppers/");
    ...
    $(".checkbox.color-transparency").change(function() {
    if(this.checked) {
